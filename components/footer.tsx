    ...
    <footer className="border-t border-paper/15 bg-night px-5 pb-[max(28px,env(safe-area-inset-bottom))] pt-10 text-paper sm:px-8 lg:px-12">
      <div className="mx-auto max-w-[1600px]">
        <div className="flex flex-col justify-between gap-12 py-10 sm:flex-row">
          ...
          <div className="flex items-center gap-8 text-xs"><Link href="/magazin">Коллекция</Link><a href="https://instagram.com" target="_blank" rel="noreferrer">Instagram</a><a href="https://t.me" target="_blank" rel="noreferrer">Telegram</a></div>
        </div>
